...
**This sink is only to be used for light traffic, and at high-load it will cause your elastic search cluster to bloat its field space beyond the recommended safe limit. For high-volume workloads use the Flattened ES sink.**
