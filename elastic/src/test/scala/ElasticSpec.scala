...
class ElasticSpec extends FlatSpec with Matchers {
  ...
  "elasticGroup" should "emit on timeout" in {
    ...
    val dp1 = Datapoint[Any](Key[Double](
      "k1", Units.Count, 0.0, "description", Map(AttributeKeys.source -> "h1")), 3.14)
    val dp2 = Datapoint[Any](Key[Double](
      "k2", Units.Count, 0.0, "description", Map(AttributeKeys.source -> "h2")), 2.17)
